...
const FORM_SIDE_IMAGE =
  'https://images.unsplash.com/photo-1497215728101-856f1ea54574?q=80&w=1200&auto=format&fit=crop';
    ...
    <SectionContainer className="bg-card">
      <div className="grid gap-10 md:gap-12 lg:gap-16 md:grid-cols-2 md:items-start">
        ...
        <div className="hidden md:block relative w-full">
          <div className="relative aspect-[4/5] max-h-[min(640px,70vh)] w-full overflow-hidden rounded-xl border border-border shadow-elegant">
            <Image
              src={FORM_SIDE_IMAGE}
