    ...
    <SectionContainer className="relative overflow-hidden bg-gradient-to-br from-primary/5 via-background to-accent/5">
      ...
      <div className="relative z-10 max-w-4xl mx-auto text-center">
        ...
        <motion.p
          ...
          From photography to packaging, we offer a full range of design and branding services to
          help your brand express its unique personality through powerful visuals and storytelling.
        </motion.p>
      </div>
    </SectionContainer>
  );
