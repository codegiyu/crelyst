    ...
    <div className="relative w-full">
      ...
      <SectionContainer
        className={cn(
          ...
          service.bannerImage ? '' : 'bg-gradient-to-br from-primary/5 via-background to-accent/5'
        )}>
        {/* Background Pattern */}
        {!service.bannerImage && (
          ...
          {/* <motion.div
            ...
            <Link
              ...
              className={cn(
                ...
                service.bannerImage ? 'text-white/90 hover:text-white' : 'text-muted-foreground'
              )}>
          ...
          <div className="text-center">
            ...
            <motion.p
              ...
              className={cn(
                ...
                service.bannerImage ? 'text-white/90' : 'text-muted-foreground'
              )}>
